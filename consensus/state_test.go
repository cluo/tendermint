...
func TestProposerSelection0(t *testing.T) {
	...
	cs1.pubsub.Subscribe(types.EventQueryNewRound, newRoundCh)
	proposalCh := make(chan interface{})
	cs1.pubsub.Subscribe(types.EventQueryCompleteProposal, proposalCh)
...
func TestEnterProposeNoPrivValidator(t *testing.T) {
	...
	cs.pubsub.Subscribe(types.EventQueryTimeoutPropose, timeoutCh)
...
func TestEnterProposeYesPrivValidator(t *testing.T) {
	...
	cs.pubsub.Subscribe(types.EventQueryTimeoutPropose, timeoutCh)
	proposalCh := make(chan interface{})
	cs.pubsub.Subscribe(types.EventQueryCompleteProposal, proposalCh)
...
func TestBadProposal(t *testing.T) {
	...
	cs1.pubsub.Subscribe(types.EventQueryVote, voteCh)
...
func TestFullRound1(t *testing.T) {
	...
	voteCh := make(chan interface{})
	cs.pubsub.Subscribe(types.EventQueryVote, voteCh)
	propCh := make(chan interface{})
	cs.pubsub.Subscribe(types.EventQueryCompleteProposal, propCh)
	newRoundCh := make(chan interface{})
	cs.pubsub.Subscribe(types.EventQueryNewRound, newRoundCh)
...
func TestFullRound2(t *testing.T) {
	...
	cs1.pubsub.Subscribe(types.EventQueryNewBlock, newBlockCh)
...
func TestLockNoPOL(t *testing.T) {
	...
	cs1.pubsub.Subscribe(types.EventQueryTimeoutPropose, timeoutProposeCh)
	timeoutWaitCh := make(chan interface{})
	cs1.pubsub.Subscribe(types.EventQueryTimeoutWait, timeoutWaitCh)
	voteCh := make(chan interface{})
	cs1.pubsub.Subscribe(types.EventQueryVote, voteCh)
	proposalCh := make(chan interface{})
	cs1.pubsub.Subscribe(types.EventQueryCompleteProposal, proposalCh)
...
func TestLockPOLRelock(t *testing.T) {
	...
	cs1.pubsub.Subscribe(types.EventQueryNewRound, newRoundCh)
	newBlockCh := make(chan interface{})
	cs1.pubsub.Subscribe(types.EventQueryNewBlockHeader, newBlockCh)
...
func TestLockPOLUnlock(t *testing.T) {
	...
	cs1.pubsub.Subscribe(types.EventQueryUnlock, unlockCh)
...
func TestLockPOLSafety1(t *testing.T) {
	...
	*/
	...
	cs1.pubsub.Subscribe(types.EventQueryNewRoundStep, newStepCh)
